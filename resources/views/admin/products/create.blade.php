                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a
                                href="{{ route('admin.product.show') }}">Products</a></li>
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a
                                href="{{ route('admin.product.create') }}">Create</a></li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Create Products</h6>
                </nav>
                        ...
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <h6 class="font-weight-bolder">Product Description</h6>
                                    <div class="input-group input-group-outline mb-3">
                                        <input type="text" class="form-control" name="description">
                                    </div>
                                    <h6 class="font-weight-bolder">Product Price</h6>
                                    <div class="input-group input-group-outline mb-3">
                                        <input type="text" class="form-control" name="price">
                                    </div>
                                    <h6 class="font-weight-bolder">Product image</h6>
                                    <div class="input-group input-group-outline mb-3">
                                    ...
                                    @foreach ($categories as $category)
                                        <div class="form-check mt-2">
                                            <input type="radio" name="permissions[]" id="{{ $category->id }}"
                                                class="form-check-input" value="{{ $category->name }}">
                                            <label for="{{ $category->id }}"
                                                class="form-check-lable">{{ $category->name }}</label>
                                        </div>
                                    @endforeach
