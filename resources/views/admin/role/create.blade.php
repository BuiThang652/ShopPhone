            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a
                                href="{{ route('admin.role.create') }}">Create</a></li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Create Roles</h6>
                </nav>
                    ...
                    <div class="card my-4">
                        <div class="card card-plain">
                            <div class="card-header">
                                <h4 class="font-weight-bolder">Create Role</h4>
                            </div>
                            <div class="card-body">
                                <form role="form" method="POST">
                                    ...
                                    <h6 class="font-weight-bolder">Tên hiển thị</h6>
                                    <div class="input-group input-group-outline mb-3">
                                        <label class="form-label">Display_name</label>
                                        <input type="text" class="form-control" name="display_name">
                                    </div>

                                    <h6 class="font-weight-bolder">Permissions</h6>
                                    @foreach ($permissions as $permission)
                                        <div class="form-check mt-2">
                                            <input type="checkbox" name="permissions[]"
                                                id="{{ $permission->display_name }}" class="form-check-input"
                                                value="{{ $permission->id }}">
                                            <label for="{{ $permission->display_name }}"
                                                class="form-check-lable">{{ $permission->display_name }}</label>
                                        </div>
                                    @endforeach
