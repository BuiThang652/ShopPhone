                                                    ...
                                                    <tr class="cart_item">
                                                        <td class="product-remove">
                                                            <a title="Remove this item" class="remove"
                                                                href="{{ route('frontend.orders.delete', ['id' => $product->id]) }}">×</a>
                                                        </td>

                                                        <td class="product-thumbnail">
                                                            <a
                                                                href="{{ Route('frontend.single-product', ['id' => $product->id]) }}"><img
                                                                    width="145" height="145" alt="poster_1_up"
                                                                    class="shop_thumbnail"
                                                                    src="{{ asset('ustora/img/' . $product->thumbnail) }}"></a>
                                                        </td>
                                                        ...
                                                        <td class="product-quantity">
                                                            <div class="quantity buttons_added">
                                                                <a class="minus" style="padding: 7px"
                                                                    href="{{ route('frontend.orders.remove', ['id' => $product->id]) }}">-</a>
                                                                <input type="number" size="4"
                                                                    class="input-text qty text" title="Qty" disabled
                                                                    value="{{ $item->quantity }}" min="0"
                                                                    step="1">
                                                                <a class="minus" style="padding: 7px"
                                                                    href="{{ route('frontend.orders.add', ['id' => $product->id]) }}">+</a>
                                                            </div>
                                                        </td>
                                ...
                                <div class="shipping_calculator">
                                    ...
                                    <section id="calcalute-shipping-wrap" class="shipping-calculator-form collapse">
                                        <form method="POST" action="" class="">
                                            ...
                                            <p><button class="button" name="calc_shipping"
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">{{ $total_amount }} VND</span></td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">{{ $total_amount }}
                                                            VND</span></strong>
                                                </td>
                                            </tr>
                                        </tbody>
